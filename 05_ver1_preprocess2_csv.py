...
# 入力ファイル
input_path = "testL_processed.csv"
output_path = "testL_processed2.csv"
...
# ① 最寄駅：名称 → 利用者数
station_df = pd.read_csv("駅の利用者.csv", encoding="utf-8-sig")
...
# ② 前面道路：種類 → 坪単価平均
road_type_df = pd.read_csv("前面道路種類別_坪単価平均.csv", encoding="utf-8-sig")
...
# ③ 地区名 → 坪単価平均
district_df = pd.read_csv("地区名別_坪単価平均.csv", encoding="utf-8-sig")
...
# ④ 土地の形状 → 坪単価平均
land_shape_df = pd.read_csv("土地形状別_坪単価平均.csv", encoding="utf-8-sig")
